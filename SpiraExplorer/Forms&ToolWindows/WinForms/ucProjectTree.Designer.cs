...
namespace Inflectra.SpiraTest.IDEIntegration.VisualStudio.WinForms.Forms
{
	partial class ucProjectTree
	{
		...
		private void InitializeComponent()
		{
			...
			this.toolProjectTree1 = new wpfProjectTree();
			this.SuspendLayout();
			// 
			// elementHost1
			// 
			...
			this.elementHost1.Size = new System.Drawing.Size(275, 343);
			this.elementHost1.TabIndex = 0;
			this.elementHost1.Text = "elementHost1";
			this.elementHost1.Child = this.toolProjectTree1;
			// 
			// ucProjectTree
			// 
			...
			this.Size = new System.Drawing.Size(275, 343);
		...
		internal wpfProjectTree toolProjectTree1;
