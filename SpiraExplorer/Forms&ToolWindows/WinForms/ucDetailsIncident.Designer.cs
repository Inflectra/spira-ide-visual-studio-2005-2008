...
{
	partial class ucDetailsIncident
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			wpfDetailsIncident1 = new wpfDetailsIncident();
			this.SuspendLayout();
			// 
			// elementHost1
			// 
			...
			this.elementHost1.Child = wpfDetailsIncident1;
			// 
			// ucDetailsIncident
			// 
		...
		internal wpfDetailsIncident wpfDetailsIncident1;
