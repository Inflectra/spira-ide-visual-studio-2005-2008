...
namespace Inflectra.SpiraTest.IDEIntegration.VisualStudio.WinForms.Forms
{
	partial class ucDetailsTask
	{
		...
		private void InitializeComponent()
		{
			...
			this.wpfDetailsTask1 = new wpfDetailsTask();
			this.SuspendLayout();
			// 
			// elementHost1
			// 
			...
			this.elementHost1.Child = this.wpfDetailsTask1;
			// 
			// ucDetailsTask
			// 
		...
		internal wpfDetailsTask wpfDetailsTask1;
